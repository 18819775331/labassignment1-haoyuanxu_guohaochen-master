...
public abstract class TrainService {
	...
	private void setZonesTravelled() {
		...
		zonesTravelled = Math.abs(arrivalStationNumber - departureStationNumber)+1;
	}
	...
	private void setDepartStation(String departStation) {
		//todo: search in the train station list for this station arriveStation and find it's index value
		this.departureStationNumber = departureStationNumber;  // change this to be the index value of the correct station
	}

	// methods for Train Services
	public double getTicketPrice() {
		double stationprice;
		stationprice = MINSERVICECOST*zonesTravelled;
		return stationprice;  // default price is minimum price
	...
	public int getZonesTravelled() {
		...
		ZonesTravelled = allStationNames[departureStationNumber]+allStationNames[arrivalStationNumber];
